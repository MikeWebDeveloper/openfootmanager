...
class PlayerProfilePage(ttk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.canvas = ttk.Canvas(self.player_details_frame)
        ...
        self.player_name_label = ttk.Label(
            self.player_details_frame,
            textvariable=self.player_name_value,
            font=("Helvetica", 20),
        )
        self.player_name_label.grid(row=0, column=1, padx=5, pady=5, sticky=NW)

        self.player_birth_date_label = ttk.Label(
            self.player_details_frame, text="Birth date: ", font=("Helvetica", 12)
        )
        ...
        self.player_nationality_label = ttk.Label(
            self.player_details_frame, text="Nationality: ", font=("Helvetica", 12)
        )
        ...
        self.positions_label = ttk.Label(
            self.player_details_frame, text="Positions: ", font=("Helvetica", 12)
        )
