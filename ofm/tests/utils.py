...
def assert_player_attributes_valid(player: Player) -> None:
    ...
    attributes = [
        "overall", "potential", "pace", "acceleration", "sprint_speed",
        "stamina", "strength", "jumping", "passing", "vision",
        "crossing", "short_passing", "long_passing", "dribbling",
        "ball_control", "first_touch", "technique", "shooting",
        "long_shots", "finishing", "heading", "aggression",
        "anticipation", "bravery", "composure", "concentration",
        "creativity", "decisions", "determination", "flair",
    ...
    if Positions(player.position) == Positions.GK:
        gk_attributes = [
            "handling", "reflexes", "one_on_ones", "command_of_area",
            "communication", "kicking", "throwing",
        ]
...
def generate_random_minute() -> int:
    ...
    weights = [
        1, 1, 1, 1, 1,  # 0-5 mins
        2, 2, 2, 2, 2,  # 5-10 mins
        3, 3, 3, 3, 3,  # 10-15 mins (high activity)
        2, 2, 2, 2, 2,  # 15-20 mins
        2, 2, 2, 2, 2,  # 20-25 mins
        2, 2, 2, 2, 2,  # 25-30 mins
        2, 2, 2, 2, 2,  # 30-35 mins
        2, 2, 2, 2, 2,  # 35-40 mins
        3, 3, 3, 3, 3,  # 40-45 mins (end of half)
        # Second half
        3, 3, 3, 3, 3,  # 45-50 mins (start of second half)
        2, 2, 2, 2, 2,  # 50-55 mins
        2, 2, 2, 2, 2,  # 55-60 mins
        2, 2, 2, 2, 2,  # 60-65 mins
        2, 2, 2, 2, 2,  # 65-70 mins
        2, 2, 2, 2, 2,  # 70-75 mins
        3, 3, 3, 3, 3,  # 75-80 mins (crucial period)
        3, 3, 3, 3, 3,  # 80-85 mins
        4, 4, 4, 4, 4,  # 85-90 mins (end game)
    ]
