...
from ofm.core.db.models.transfer import Transfer, TransferOffer
...
class TestTransferSystem:
    ...
    def test_create_transfer_offer(self, test_db_session, sample_club):
        ...
        selling_club = TestDataFactory.create_test_club(test_db_session, name="Selling FC")
    ...
    def test_reject_transfer_offer(self, test_db_session, sample_club):
        ...
        player = TestDataFactory.create_test_player(test_db_session, club=selling_club)
    ...
    def test_loan_transfer(self, test_db_session):
        ...
        # Create clubs and player
        parent_club = TestDataFactory.create_test_club(test_db_session, name="Parent FC")
        loan_club = TestDataFactory.create_test_club(test_db_session, name="Loan FC")
        player = TestDataFactory.create_test_player(
            test_db_session,
            name="Loan Player",
            club=parent_club,
    ...
    def test_transfer_history(self, test_db_session):
        ...
        transfers = (
            test_db_session.query(Transfer)
