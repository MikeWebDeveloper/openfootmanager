...
from ..db.models.transfer import (
    TransferNegotiation, TransferStatus, TransferType,
...
class TransferNegotiator:
    ...
    def negotiate_loan_terms(
        ...
        Returns:
            Tuple of (accepted, message)
        """
        if negotiation.transfer_type not in [TransferType.LOAN, TransferType.LOAN_TO_BUY]:
...
class ContractNegotiator:
    ...
    def create_contract_offer(
        ...
        contract = ContractOffer(
            ...
            agent_fee=self._calculate_agent_fee(negotiation.agreed_fee or negotiation.current_offer)
        )
    ...
    def _player_accepts_contract(self, contract: ContractOffer) -> bool:
        ...
        if wage_ratio >= 0.85:
            ...
            if contract.signing_bonus > contract.player_demanded_wage * 15:
                return True
            if contract.release_clause and contract.release_clause < contract.player_demanded_wage * 1000:
                return True
