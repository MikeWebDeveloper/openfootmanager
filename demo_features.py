...
from ofm.core.db.models import Competition, Fixture, FixtureStatus, League, SaveGame, SaveType
from ofm.core.db.models.base import Base, engine, SessionLocal
from ofm.core.save.save_manager import SaveManager
from ofm.core.season.calendar import GameCalendar, CalendarEventType
...
def demo_integration_features(session, settings):
    ...
    print(f"   ✓ Created 3 autosaves tracking progress")
